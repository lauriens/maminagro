...
namespace BancoDeEspecies.DataAccess.Migrations
{
    ...
    [Migration("20240113175101_Make-TimeSincePlantingUnit-Optional-ForCulture")]
    partial class MakeTimeSincePlantingUnitOptionalForCulture
    {
            ...
            modelBuilder.Entity("BancoDeEspecies.Domain.Models.Agroecosystem", b =>
                {
                    ...
                    b.ToTable("Agroecosystems", (string)null);
                });
            ...
            modelBuilder.Entity("BancoDeEspecies.Domain.Models.Landscape", b =>
                {
                    ...
                    b.Property<int?>("AgroecosystemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BancoDeEspecies.Domain.Models.Landscape", b =>
                {
                    ...
                    b.Navigation("LandscapeLocalities");
