...
namespace BancoDeEspecies.Application.Services
{
    ...
    public class LandscapeService : BaseService<Landscape, LandscapeViewModel, CreateLandscapeViewModel>, ILandscapeService
    {
        ...
        public new async Task<IEnumerable<LandscapeViewModel>> GetAllAsync()
        {
            ...
            var result = await repository.Get(includeProperties: "Anthrome,Municipality.Uf,SampleAreaType,Reference.ReferenceType,Reference.StudyCollectMethods.MaterialDestination,Abundances,Biomes,LandscapeAreaTypes.AreaType,LandscapeStatistics,Localities.LocalityType");
